...
TAB_APPEARANCES: dict[ActorStatus, TabAppearance] = {
    ActorStatus.IDLE: TabAppearance(RGB(92, 99, 112), LIGHT_TEXT, RGB(51, 55, 63), INACTIVE_TEXT),
    ActorStatus.THINKING: TabAppearance(RGB(198, 120, 221), RGB(26, 6, 32), RGB(74, 43, 82), INACTIVE_TEXT),
    ActorStatus.WORKING: TabAppearance(RGB(198, 120, 221), RGB(26, 6, 32), RGB(74, 43, 82), INACTIVE_TEXT),
    ActorStatus.EXECUTING: TabAppearance(RGB(97, 175, 239), RGB(6, 18, 31), RGB(44, 74, 99), INACTIVE_TEXT),

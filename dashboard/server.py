...
# The per-session metadata builders (title/git/ctx/goal, with their memo caches)
# live in dashboard/read/meta.py; the shared memo primitives in read/cache.py.
from dashboard.read.cache import MEMO_CAP
from dashboard.read.meta import (  # noqa: F401  -- facade re-export of the meta read model
    canon_cwd, git_info, session_ctx, session_goal, session_title,
    _git_dirty, _git_resolve, _group_dir, _rename_override,
)
...
from dashboard.read.cache import _db_cached, _db_sig  # noqa: F401  facade re-export

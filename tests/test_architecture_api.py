...
def test_owned_packages_never_use_raw() -> None:
    ...
    typed_registry_allowlist = {
        ...
        "client/_render_extension_blocks.py": {"PAINTERS"},
        "client/_render_extension_items.py": {"NODE_MARKS"},
        "client/_render_extension_text.py": {"TONE_COLORS"},
        "client/_render_styles.py": {"FILE_VERBS", "PLAN_DECISIONS", "TASK_MARKERS"},
        "client/claude_hook.py": {"reply"},
        "client/_selector_keys.py": {"KEYS"},
        ...
        "terminal/extension_panes.py": {"tags"},

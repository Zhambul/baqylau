...
def test_only_daemon_and_audit_cli_build_repos() -> None:
    ...
    allowed_builders = {
        ...
        "app/provider_extensions.py",
        "app/provider_extension_runtime.py",
        "app/provider_extension_storage.py",
        "app/provider_extension_terminal.py",
        "app/provider_extension_controls.py",
        "app/provider_extension_health.py",
        "app/provider_extension_jobs.py",
        "app/provider_extension_settings.py",
        ...
        "app/provider_projections.py",
        "app/provider_operation_history.py",
        "app/provider_reprocessing.py",
        "app/provider_scope_relations.py",
        "app/provider_worker_services.py",

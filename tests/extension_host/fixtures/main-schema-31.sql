...
;
INSERT OR IGNORE INTO canonical_histories(history_revision) VALUES('default');
...
;
CREATE VIEW IF NOT EXISTS current_canonical_events AS SELECT * FROM canonical_events WHERE history_revision='default';
CREATE VIEW IF NOT EXISTS current_interpretations AS SELECT * FROM interpretations WHERE history_revision='default';
CREATE VIEW IF NOT EXISTS current_interpretation_events AS SELECT * FROM interpretation_events WHERE history_revision='default';

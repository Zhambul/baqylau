...
# The fg_running test moved to tests/test_l1j_facets.py with its subject: the
# reader is plugins.fg_running now (claude_code's own hook protocol), not a core
# function — see the note where it used to live in core/sessionapi.py.

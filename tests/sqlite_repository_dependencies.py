...
from repository.impl.sqlite.extension_jobs import SqliteExtensionJobRepository as SqliteExtensionJobRepository
from repository.impl.sqlite.extension_projections import (
    SqliteExtensionProjectionRepository as SqliteExtensionProjectionRepository,
)
from repository.impl.sqlite.extension_records import (
    SqliteExtensionRecordRepository as SqliteExtensionRecordRepository,
)

...
"""Read the extension catalog and record pages, and request a catalog rescan."""
...
class ExtensionCatalogReads:
    """Read the stored catalog and records through the public API."""

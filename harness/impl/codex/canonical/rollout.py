# harness/impl/codex/canonical/rollout.py — codex ROLLOUT-record parsing.
#
# The parse half of the codex stream's parse/paint split — the same shape as
# harness/impl/claude_code/canonical/transcript.py (docs/sessionapi.md). This module is the

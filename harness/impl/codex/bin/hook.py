...
The path external configuration names (~/.codex/hooks.json). It lives HERE, inside the harness
...
implementation is `harness/impl/codex/hooks/entry.py`, free to move

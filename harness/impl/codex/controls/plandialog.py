...
from harness.impl.codex.controls.dialog import (CodexAskError, STEP_TIMEOUT_S, _cursor_to,
                                   _poll, rows)
...
def _decide_row(fe, win, num, sleep):

...
# claude-substream.py — entry point; the implementation lives in
# plugins/claude_code/substream.py (docs/architecture.md). This filename is
...
from plugins.claude_code import substream

...
- **Web STOP "did nothing" — the turn KEPT RUNNING (and the tab may have flipped
  ...
  VERIFIES via the `esc to interrupt` spinner and re-presses: a `web-interrupt

...
- **Clicking a Read/Update/Write line doesn't expand (or won't collapse)** — the
  ...
  toggle)` carry the failure detail. A freshly toggled pane opening SCROLLED

...
day_of_week  # unused variable (app/insights.py:32)
active_session_count  # unused variable (app/insights.py:47)
finished_session_count  # unused variable (app/insights.py:48)
last_session_at  # unused variable (app/insights.py:63)
daily_sessions  # unused variable (app/insights.py:64)
total_session_count  # unused variable (app/insights.py:70)
daily_sessions  # unused variable (app/insights.py:71)
hourly_sessions  # unused variable (app/insights.py:72)
last_seven_days  # unused variable (app/insights.py:73)
last_thirty_days  # unused variable (app/insights.py:74)
all_time  # unused variable (app/insights.py:75)
dirty  # unused variable (app/repository.py:14)
restored_text  # unused variable (contracts/harness.py:460)
restored_text  # unused variable (contracts/harness.py:470)
target_account_id  # unused variable (contracts/harness.py:476)
efforts  # unused variable (contracts/harness.py:587)
resets_at  # unused variable (contracts/harness.py:595)
resets_at  # unused variable (contracts/harness.py:605)
switchable  # unused variable (contracts/harness.py:613)
scheduling_allowed  # unused variable (contracts/harness.py:617)
authentication_error  # unused variable (contracts/harness.py:619)
minimum_prompt_count  # unused variable (contracts/harness.py:626)
...
ACCOUNT_CONFIG_DIRECTORY  # unused variable (plugins/claude_code/account.py:10)
SUPPORTED_SHELLS  # unused variable (plugins/claude_code/account.py:12)
TAIL_SCAN_BYTES  # unused variable (plugins/claude_code/model.py:30)
MODEL_LADDER  # unused variable (plugins/claude_code/model.py:218)
SCREEN_LIMIT  # unused variable (plugins/claude_code/screen_driver.py:9)
KINDS  # unused variable (plugins/claude_code/transcript.py:291)
TITLE_SCAN  # unused variable (plugins/claude_code/transcript.py:496)
TITLE_TAIL_B  # unused variable (plugins/claude_code/transcript.py:500)
APPROVE_OPTIONS  # unused variable (plugins/codex/plandialog.py:46)
KINDS  # unused variable (plugins/codex/rollout.py:971)
BRIEF_MAX_LINES  # unused variable (plugins/codex/rollout.py:1064)
BRIEF_MAX_B  # unused variable (plugins/codex/rollout.py:1065)
TITLE_HEAD_LINES  # unused variable (plugins/codex/title.py:32)
STATE_DB_TTL_S  # unused variable (plugins/codex/title.py:36)
compacting_actor_ids  # unused variable (runtime/projections.py:304)
running_operation_ids  # unused variable (runtime/projections.py:333)
monitor_count  # unused variable (runtime/projections.py:334)
background_job_count  # unused variable (runtime/projections.py:335)
_.background_work  # unused method (runtime/projections.py:848)

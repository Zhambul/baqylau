...
def auto_name_session(request: ControlRequest, context: ControlContext) -> ControlResult:
...
def open_rewind(request: ControlRequest, context: ControlContext) -> ControlResult:
...
def apply_rewind(request: ControlRequest, context: ControlContext) -> RewindResult:
    terminal = context.terminal
...
def migrate_account(request: ControlRequest, context: ControlContext) -> MigrationResult:

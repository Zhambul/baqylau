...
# claude-cmd-blocked.py — entry point; the implementation lives in
# plugins/claude_code/cmd_blocked.py (docs/architecture.md). This filename is
...
from plugins.claude_code import cmd_blocked

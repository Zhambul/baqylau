...
# claude-skill-fmt.py — entry point; the implementation lives in
# plugins/claude_code/skill_fmt.py (docs/architecture.md). This filename is
...
from plugins.claude_code import skill_fmt

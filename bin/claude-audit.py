...
# The implementation lives in core/auditcli.py — the audit trail's read/report
# tier over core/audit.py's writer (docs/architecture.md); this file
...
from core import auditcli as _impl
...
if __name__ == "__main__":
    try:
        ...
        # Derived from core/auditcli.py's command table so the two can't drift.
